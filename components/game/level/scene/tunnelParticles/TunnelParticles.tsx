...
const CustomTunnelShaderMaterial = shaderMaterial(INITIAL_POINTS_UNIFORMS, particleVertex, particleFragment)
...
const TunnelParticles: FC<Props> = ({ isMobile }) => {
  ...
  useLayoutEffect(() => {
    ...
    try {
      ...
      // Set uniforms
      positionUniforms.current = positionVariable.current.material.uniforms as PositionShaderUniforms
